...
class _$StatisticDataTearOff {
  ...
  _StatisticData call({List<Pair<Duration, Rational>> dailyProgress, int active}) {
...
abstract class $StatisticDataCopyWith<$Res> {
  ...
  $Res call({List<Pair<Duration, Rational>> dailyProgress, int active});
}
...
class _$_StatisticData implements _StatisticData {
  _$_StatisticData({this.dailyProgress, this.active});
  ...
  @override
  String toString() {
    return 'StatisticData(dailyProgress: $dailyProgress, active: $active)';
  }
...
abstract class _StatisticData implements StatisticData {
  factory _StatisticData({List<Pair<Duration, Rational>> dailyProgress, int active}) = _$_StatisticData;
